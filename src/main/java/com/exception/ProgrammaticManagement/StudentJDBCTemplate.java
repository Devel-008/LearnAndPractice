...
public class StudentJDBCTemplate implements StudentDAO {
    ...
    public void create(String name, Integer age, Integer marks, Integer year){
        ...
        try {
            ...
            String SQL3 = "insert into studentRecordMarks(sid, marks, years) " + "values (?, ?, ?)";
    ...
    public List<StudentMarks> listStudents() {
        String SQL = "select * from studentRecords, studentRecordMarks where studentRecords.id = studentRecordMarks.sid";
